...
class DottedNameResolver(Resolver):
    ...
    * https://github.com/Pylons/pyramid/blob/master/pyramid/path.py#L211
    ...
    - The constant value :attr:`dotted_name_resolver.CALLER_PACKAGE`.

    The default value is :attr:`dotted_name_resolver.CALLER_PACKAGE`.

    The ``package`` is used when a relative dotted name is supplied to the
    :meth:`~dotted_name_resolver.DottedNameResolver.resolve` method.  A dotted name
    ...
    If ``package`` is :attr:`dotted_name_resolver.CALLER_PACKAGE`,
    the resolver will treat relative dotted names as relative to
    the caller of the :meth:`~dotted_name_resolver.DottedNameResolver.resolve`
    method.
    ...
    :meth:`~dotted_name_resolver.DottedNameResolver.resolve` method, the resulting
    ...
    def maybe_resolve(self, dotted):
        ...
        :meth:`~dotted_name_resolver.DottedNameResolver.resolve`, except if the
